<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExtensionAdd.ascx.cs" Inherits="RipsValidadorWeb.UserControls.ExtensionAdd" %>
            ...
            <tr>
                <td style="width:25%;">
                    <div style="text-align:center">
                        <asp:Label runat="server" ID="lblExtension" Font-Bold="true">Extension:</asp:Label>
                    </div>
                </td>
                <td style="width:25%;">
                    <telerik:RadTextBox runat="server" ID="txtExtension" MaxLength="3" Text='<%#DataBinder.Eval(Container, "DataItem.text")%>'></telerik:RadTextBox>                    
                </td>
                <td style="width:25%;">
                    <div style="text-align:center">
                ...
                <td style="width:25%;">
                    <telerik:RadTextBox runat="server" ID="txtDescipcion" MaxLength="250" Text='<%#DataBinder.Eval(Container, "DataItem.descripcion")%>'></telerik:RadTextBox>                    
                </td>
            </tr>
            <tr>
